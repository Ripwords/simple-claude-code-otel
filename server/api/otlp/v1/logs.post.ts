import { buildEventInserts, buildSessionUpserts, transformLogs, type OtlpLogsBody } from '../../../utils/otlp'
...
export default defineEventHandler(async (event) => {
  ...
  const statements = [...buildSessionUpserts(result.sessions), ...buildEventInserts(result.rows)]
